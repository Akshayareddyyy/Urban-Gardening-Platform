...
export default function HomePage() {
  ...
  console.log('HomePage: isLoading:', isLoading, 'isAuthenticated:', isAuthenticated, 'user:', user ? user.uid : null);

  if (isLoading) {
    console.log('HomePage: Rendering loader.');
    return (
  ...
  if (!isAuthenticated) {
    console.log('HomePage: Rendering PublicLandingPage because user is NOT authenticated.');
    return <PublicLandingPage />;
  }

  console.log('HomePage: Rendering authenticated content (PlantSearch).');
  return (
